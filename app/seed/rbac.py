...
PERMISSIONS: dict[str, tuple[str, str, str]] = {
    ...
    "audit:create": ("audit", "create", "Create new audit session"),
    "audit:score": ("audit", "score", "Input or score audit items"),
    "audit:publish": ("audit", "publish", "Publish audit session & report"),
